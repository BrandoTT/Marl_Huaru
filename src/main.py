...
def _get_config(params, arg_name=None, subfolder=None, re_config_name=None):
    config_name = None
    for _i, _v in enumerate(params):
        if _v.split("=")[0] == arg_name:
            ...
            del params[_i]
            break
    if re_config_name is not None:
        config_name = re_config_name
...
if __name__ == '__main__':
    ...
    # env_config = _get_config(params, subfolder="envs", re_config_name="huarubattle")
    alg_config = _get_config(params, "--config", "algs")
    # alg_config = _get_config(params, subfolder="algs", re_config_name="mappo")
