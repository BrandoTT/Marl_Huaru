    ...
    def __start_env(self):
        if self.mode == 'host':
            docker_run = "docker run --network host -itd --name {} -v /home/ds/soft/RTMData:/home/x64/RTMData -w /home/x64 {} python daemon_server.py {} {} {} {}"\
                .format(self.docker_name, self.image_name, self.xsim_time_ratio, self.port, HostID, RTMNum)
        else:
            docker_run = "docker run -p {}:{} -itd --name {} -w /home/x64 {} python daemon_server.py {} {} {}  {}"\
